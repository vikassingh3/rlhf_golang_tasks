...
func main() {
	...
	// Create a new flock.Flock instance for the lock file
	...
	// Open the file for reading and writing, creating it if necessary, and setting permissions
	...
	// Write the modified content back to the file with the same permissions (0644)
