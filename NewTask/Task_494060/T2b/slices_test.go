...
func TestSliceAccess(t *testing.T) {
	...
	// Use assert.Panics to check for panic when accessing out of bounds
	assert.Panics(t, func() { _ = slice[10] }, "Expected panic when accessing index out of bounds")
